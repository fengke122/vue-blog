      ...
      <div class="container" v-show="flag">
        ...
        <div class="right">
          ...
          <div class="right-item right-item3">
            ...
            <span v-for="item in weekrank" class="font-right" @click="toBlog(item.id)">{{item.id }} {{item.title}}</span>
          </div>
          <div class="right-item right-item4" >
            ...
            <span v-for="item in dayrank" class="font-right" @click="toBlog(item.id)">{{item.id }} {{item.title}}</span>
          </div>
        </div>
      </div>
    </div>
